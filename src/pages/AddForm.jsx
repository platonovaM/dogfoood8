        ...
        <Row>
            <Col xs ={12} md={6}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type ="number" value={price} onChange={e=>setPrice(e.target.value)} step="10" min={0}></Form.Control>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>Вес</Form.Label>
                    <Form.Control type ="text" value={wight} placeholder="100г" onChange={e=>setWight(e.target.value)}></Form.Control>
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type ="number" value={stock} onChange={e=>setStock(e.target.value)} min={0}></Form.Control>
                </Form.Group>
                </Col>
            <Col xs ={12} md={6}>
                    <div className="form-preview mb-2" style ={{backgroundImage: pictures ? `url(${pictures})` : "url(https://warm-floors.ru/uploads/no-foto.png)"}}></div>
                    <Form.Group className="mb-3">
